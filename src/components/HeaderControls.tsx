/**
 * Header controls — search dialog (⌘K), theme switcher, accent picker, sign-in.
 * One React island for the whole interactive cluster so we ship a single
 * hydration boundary. Adapted from oriz-home but takes FamilySite[] from
 * @chirag127/oriz-ui rather than a local Site type.
 */
